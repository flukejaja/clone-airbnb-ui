    ...
    return (
        <div id="root">
            <Modal
                ...
                style={customStyles}
            >
                <div className='h-14 flex justify-around  border-b items-center w-full max-w-full '>
                    <div className='w-2/6 '>
                        <a href='/' className="h-8 w-8 hover:bg-gray-200 rounded-full px-2 py-1">&#10005;</a>
                    </div>
                    <div className='w-2/6 whitespace-nowrap font-semibold flex justify-center items-center text-sm'>เข้าสู่ระบบหรือลงทะเบียน</div>
                    <div className='w-2/6 justify-center items-center '></div>
                </div>
...
export default AuthpageFullScreen